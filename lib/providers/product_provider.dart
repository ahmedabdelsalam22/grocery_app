...
class ProductsProvider with ChangeNotifier
 {
   ...
   {
     List<ProductModel> categoryList = productsList.where(
             (element) =>element.productCategoryName.toLowerCase()
   ...
   {
     List<ProductModel> searchList = productsList.where(
